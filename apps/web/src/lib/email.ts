...
/**
 * How this app sends mail. Identical policy to `apps/admin` — see there for the
 * reasoning; repeated rather than shared because the two apps are free to send
 * through different providers, and a shared module would quietly couple them.
 *
