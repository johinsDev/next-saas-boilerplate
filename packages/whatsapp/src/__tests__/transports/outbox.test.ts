...
/**
 * Outbox transport unit tests use a stub Drizzle-like db. The real
 * package depends on the schema being added in @saas/db; integration
 * with the real DB is covered by the admin-panel + e2e endpoint instead.
 */
