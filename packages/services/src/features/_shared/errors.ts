 ...
 *
 * Services must not throw transport errors. A `TRPCError` thrown from a service
 ...
 *
 * The codes deliberately match the vocabulary tRPC and Hono already share, so
 * the mapping at the edge stays a lookup rather than a translation.
 */
